...
namespace ConferenceTracker.test
{
    ...
    public class TestApi
    {
        ...
        public void TestMissingConference()
        {
            ...
            {
                HttpStatusCode code;
                var conferenceInfo = Helpers.Get<ConferenceInfo>(Server.Instance.BaseAddress + "conference/GIS/info", out code);
        ...
        public void TestAdvertize()
        {
            ...
            {
                HttpStatusCode code;
                var responseBody = Helpers.Put<ConferenceInfo>(Server.Instance.BaseAddress + "conference/GIS/info", null, out code);
                ...
                responseBody = Helpers.Put<ConferenceInfo>(Server.Instance.BaseAddress + "conference/GIS/info", _gisConf.Info, out code);
        ...
        public void TestPutTwice()
        {
            WrapServerContext(delegate
            {
                ...
                Assert.AreEqual(_gisConf.Info, conferences[0].Info, "Объект должен полностью соответствовать последнему зарегистрированному");
            });
        }
        ...
        public void TestMissingAdvertize()
        {
            ...
            {
                HttpStatusCode code;
                var responseBody = Helpers.Put<ConferenceInfo>(Server.Instance.BaseAddress + "conference/GIS/info", _gisConf.Info,  out code);
